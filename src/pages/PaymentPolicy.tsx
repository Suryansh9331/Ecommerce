    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32 2xl:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">2. ACCEPTED PAYMENT METHODS</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">3. PAYMENT GATEWAY SECURITY</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">4. PAYMENT CONFIRMATION</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">5. CASH ON DELIVERY (COD)</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">6. REFUND PROCESSING</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">7. PAYMENT DISPUTES AND CHARGEBACKS</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">8. FRAUD PREVENTION</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">9. SELLER PAYOUTS AND SETTLEMENTS</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">10. INVOICE AND TAXATION</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
