      ...
      <div className="bg-white rounded-lg p-6 border">
        ...
        {step === 2 && (
          <div>
            ...
            <div className="space-y-4 mb-6">
              {Object.entries(savedAddresses).map(([key, address]) => (
                <label 
                  ...
                  className={`
                    block p-4 border rounded-lg cursor-pointer transition-colors
                    ${selectedAddress === key ? 'border-primary-600 bg-primary-600/5' : 'hover:border-gray-300'}
                  `}
                >
                  <div className="flex items-center gap-3">
                    <input
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-primary-600">Edit</span>
                      </div>
            ...
            <button className="w-full py-3 border border-primary-600 text-primary-600 rounded-lg hover:bg-primary-600/5 transition-colors">
              Add New Address
            </button>
          </div>
        )}
