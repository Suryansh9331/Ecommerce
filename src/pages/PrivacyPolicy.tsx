    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32 2xl:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">2. DATA WE COLLECT</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">3. LEGAL PURPOSES OF DATA COLLECTION</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">4. HOW WE USE DATA</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">5. DATA SHARING</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">6. DATA STORAGE & RETENTION</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">7. SECURITY PRACTICES</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">8. USER RIGHTS UNDER DPDP ACT</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">9. CHILDREN’S PRIVACY</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">10. COOKIES</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">11. INTERNATIONAL DATA TRANSFERS</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">12. GRIEVANCE REDRESSAL</h2>
            ...
            <div className="text-gray-700 mb-4 text-sm sm:text-base">
              <p>Email: <span className="text-primary-600">infoaoinstore@gmail.com</span></p>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">13. POLICY CHANGES</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-primary-600 mb-3 sm:mb-4">14. LEGAL LIABILITY</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
