...
const statusColors: Record<VerificationStatusType, string> = {
  ...
  pending: 'text-primary-700 bg-primary-50 border-primary-300',
  under_review: 'text-primary-700 bg-primary-50 border-primary-300',
  documents_submitted: 'text-primary-700 bg-primary-50 border-primary-300',
  email_verified: 'text-primary-700 bg-primary-50 border-primary-300'
};
...
const statusIcons: Record<VerificationStatusType, JSX.Element> = {
  ...
  pending: <ClockIcon className="h-5 w-5 text-primary-600" />,
  under_review: <ClockIcon className="h-5 w-5 text-primary-600" />,
  documents_submitted: <DocumentIcon className="h-5 w-5 text-primary-600" />,
  email_verified: <CheckCircleIcon className="h-5 w-5 text-primary-600" />
};
  ...
  if (!verificationData) {
    return (
      <div className="max-w-5xl mx-auto py-8 px-4 text-center">
        <ExclamationTriangleIcon className="h-12 w-12 text-primary-400 mx-auto mb-4" />
    ...
    <div className="max-w-5xl mx-auto py-8 px-4">
                ...
                <tr>
                  <td colSpan={5} className="px-6 py-4 text-center text-sm text-gray-500">
                    <div className="flex flex-col items-center justify-center py-6">
                      <ExclamationTriangleIcon className="h-12 w-12 text-primary-400 mb-3" />
      ...
      <div className="mt-8 rounded-lg border border-gray-200 bg-white p-6">
        ...
        {['pending', 'email_verified', 'documents_submitted', 'under_review'].includes(status) && (
          <div className="space-y-3">
            <p className="text-primary-700">Your verification is in progress. Please note:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-2">
