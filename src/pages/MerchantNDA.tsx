        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 mb-4 space-y-1 text-sm sm:text-base">
              ...
              <li>Aoinstore does not own, manufacture, store, or control Merchant products.</li>
              <li>Aoinstore is not a party to any transaction between buyer and Seller.</li>
              <li>Aoinstore operates strictly as an intermediary under IT Act 2000 Section 79.</li>
              <li>The Merchant is fully responsible for product quality, authenticity, safety, legality, packaging, and post-sale responsibilities.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 mb-4 space-y-1 text-sm sm:text-base">
              ...
              <li>Merchant shall not disclose platform data, customer data, algorithms, financial terms, or operational details.</li>
              <li>Merchant shall not misuse Aoinstore brand assets, trademarks, or customer information.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 mb-4 space-y-1 text-sm sm:text-base">
              ...
              <li>Ensuring full compliance with Consumer Protection Act 2019, E-Commerce Rules 2020, GST Act, Legal Metrology Act, and all applicable laws.</li>
              <li>Proper packaging, labeling, and shipment readiness.</li>
              <li>Honoring all return, replacement, and warranty obligations.</li>
              <li>Complying with tax invoicing, GST filings, and legal documentation.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 mb-4 space-y-1 text-sm sm:text-base">
              ...
              <li>Legal claims or consumer court cases.</li>
              <li>Tax issues, incorrect invoicing, or GST violations.</li>
              <li>Delivery delays or courier partner faults.</li>
              <li>Listing errors, misinformation, or regulatory non-compliance by the Merchant.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-4 sm:pl-6 text-gray-700 mb-4 space-y-1 text-sm sm:text-base">
              ...
              <li>Counterfeit or unsafe products.</li>
