        ...
        <div className="text-center" style={{ width: '100%' }}>
          ...
          {displayStatus === 'success' && (
            <>
              ...
              <button
                onClick={() => navigate('/')}
                className="bg-primary-600 text-white py-2 px-6 rounded-md hover:bg-primary-600 transition-colors"
              >
                Go to Home Page
              </button>
            </>
            ...
            <>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-primary-600 text-white py-2 px-4 rounded-md hover:bg-primary-600 transition-colors"
                >
                  Go to Sign In
                </button>
              ...
              <div className="mt-6">
                ...
                <button
                  ...
                  className="w-full bg-primary-600 text-white py-2 rounded-md hover:bg-primary-600 transition-colors disabled:bg-gray-400"
                >
