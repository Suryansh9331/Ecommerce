    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-16 xl:px-32 2xl:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">2. DELIVERY COVERAGE</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">3. SHIPPING METHODS</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">4. ORDER PROCESSING TIME</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">5. ESTIMATED DELIVERY TIME</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">6. ORDER TRACKING</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">7. SHIPPING CHARGES</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">8. DELIVERY ATTEMPTS</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">9. DELAYED DELIVERY</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">10. DAMAGED OR TAMPERED PACKAGES</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">11. FAILED DELIVERY AND RTO POLICY</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">12. INTERNATIONAL SHIPPING</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">13. LEGAL COMPLIANCE</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-medium text-[#FF4D00] mb-3 sm:mb-4">14. FINAL DECISION AUTHORITY</h2>
            <p className="text-gray-700 mb-4 text-sm sm:text-base">
